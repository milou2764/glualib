...
---@param key number The key to toggle the magnet, see [KEY](/gmod/Enums/KEY) 
...
---@param data table The table containing properties to apply. See [PhysProperties](/gmod/Structures/PhysProperties) 
